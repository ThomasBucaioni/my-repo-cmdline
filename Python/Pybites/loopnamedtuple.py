...
def get_total_points(belts=ninja_belts):
    ...
    s = 0
    for key in ninja_belts:
        # print(f'{key=}, {ninja_belts[key]=}')
        # print(f'{ninja_belts[key].score=}')
        # print(f'{ninja_belts[key].ninjas=}')
        s += ninja_belts[key].score * ninja_belts[key].ninjas
    return s
