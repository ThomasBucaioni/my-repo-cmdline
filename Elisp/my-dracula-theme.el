...
;;                (dracula-comment "#6272a4" "#5f5faf" "blue")        ; official comment
                (dracula-comment "#ffd000" "#ffffff" "custom")        ; unofficial comment (gold: FF7E00, light orange: ffd000)
      ...
      (faces '(;; default
               ...
               (highlight-indentation-face :background ,bg4)
               ...
               (show-paren-match-face :background unspecified
                                      :foreground ,dracula-green;dracula-cyan
                                      :weight bold)
